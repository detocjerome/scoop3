package fr.ifremer.scoop3.gui.data.slider;
...
/**
 * SOURCE : https://github.com/ernieyu/Swing-range-slider/tree/master/src/slider
 *
...
public class RangeSliderDemo extends JPanel {
     ...
     *
     */
    private static final long serialVersionUID = -1743805144333805744L;
	...
	rangeSlider.addChangeListener((final ChangeEvent e) -> {
	...
	try {
	    ...
	    SC3Logger.LOGGER.error(ex.getMessage(), ex);
	}

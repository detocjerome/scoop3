...
public class TableCellListener implements PropertyChangeListener, Runnable {
     ...
     */
    private TableCellListener(final JTable table, final int row, final int column, final Object oldValue,
	...
	if ((newValue != null) && !newValue.equals(oldValue)) {
	    ...
	    final TableCellListener tcl = new TableCellListener(getTable(), getRow(), getColumn(), getOldValue(),
		    getNewValue());

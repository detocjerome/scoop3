...
/**
 * Valeur de type entière avec un QC NULL
 *
 * @author jdetoc
 *
 */
public class IntValueNoQC extends ValueAndQC implements Serializable {
     ...
     * @param value
     */
    public IntValueNoQC(final int value) {
	this(value, null);
    }
     ...
     * @param qc
     */
    public IntValueNoQC(final int value, final QCValues qc) {
	super(qc);
	setValue(value);
    }
	...
	return new IntValueNoQC(value, getQc());
    }
